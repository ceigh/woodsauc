...
30)+"... \u0432\u044b\u043a\u0443\u043f\u0438\u043b\u0438!":buyWinner+" \u0432\u044b\u043a\u0443\u043f\u0438\u043b\u0438!",sendNotification("\u0410\u0443\u043a\u0446\u0438\u043e\u043d \u043e\u043a\u043e\u043d\u0447\u0435\u043d!",{body:'\u0412\u044b\u043a\u0443\u043f\u0438\u043b\u0438 "'+(30<buyWinner.length?buyWinner.substring(0,30)+"...":buyWinner)+'"!',dir:"ltr",lang:"ru",icon:"/static/dist/img/favicon/favicon.png"})):(a.children[0].innerText=d+" \u043f\u043e\u0431\u0435\u0434\u0438\u043b!",document.title=
30<d.length?d.substring(0,30)+"... \u043f\u043e\u0431\u0435\u0434\u0438\u043b!":d+" \u043f\u043e\u0431\u0435\u0434\u0438\u043b!","\u041d\u0438\u043a\u0442\u043e \u043d\u0435 "===d?sendNotification("\u0410\u0443\u043a\u0446\u0438\u043e\u043d \u043e\u043a\u043e\u043d\u0447\u0435\u043d!",{body:"\u041d\u0438\u043a\u0442\u043e \u043d\u0435 \u043f\u043e\u0431\u0435\u0434\u0438\u043b :(",dir:"ltr",lang:"ru",icon:"/static/dist/img/favicon/favicon.png"}):sendNotification("\u0410\u0443\u043a\u0446\u0438\u043e\u043d \u043e\u043a\u043e\u043d\u0447\u0435\u043d!",
{body:"\u041f\u043e\u0431\u0435\u0434\u0430 "+(30<d.length?d.substring(0,30)+'..."':d)+"!",dir:"ltr",lang:"ru",icon:"/static/dist/img/favicon/favicon.png"}));b.classList.toggle("closed");a.classList.toggle("closed");notificationSound()}var startTime,timer=document.getElementById("timer"),minsCookie=getCookie("previousMinutes");minsCookie&&(timer.innerHTML=minsCookie+":00:00");
var timerArray=timer.innerHTML.split(":"),m=+timerArray[0],s=+timerArray[1],ms=+timerArray[2],timerTime=new Date(6E4*m+1E3*s+ms);
...
d+"\u20bd Pog!";document.title=30<a.length?a.substring(0,30)+'..." \u0432\u044b\u043a\u0443\u043f\u0438\u043b\u0438!':a+" \u0432\u044b\u043a\u0443\u043f\u0438\u043b\u0438!";c.classList.toggle("closed");e.classList.toggle("closed");notificationSound();sendNotification("\u0410\u0443\u043a\u0446\u0438\u043e\u043d \u043e\u043a\u043e\u043d\u0447\u0435\u043d!",{body:'\u0412\u044b\u043a\u0443\u043f\u0438\u043b\u0438 "'+(30<a.length?a.substring(0,30)+"...":a)+'"!',dir:"ltr",lang:"ru",icon:"/static/dist/img/favicon/favicon.png"})}}
