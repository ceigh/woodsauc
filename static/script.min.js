...
saveDAURLBtn.onclick=function(){var a=daURL.value;a=a.substr(a.lastIndexOf("token=")+6);setCookie("token",a,{expires:year});alert("\u0422\u043e\u043a\u0435\u043d \u0441\u043e\u0445\u0440\u0430\u043d\u0435\u043d");location.reload()};clearDAURLBtn.onclick=function(){daURL.value="";setCookie("token","",{expires:year});location.reload()};
document.onkeydown=function(a){var b=document.querySelector("#modal"),c=document.querySelector("#modal-overlay");if("Escape"===a.key||"Enter"===a.key)b.className="closed",c.className="closed"};function changeTitle(a){a.setAttribute("title","\u0421\u0443\u043c\u043c\u0430"+(a.value?": "+a.value+" \u20bd":""))}var resetButton=document.getElementById("reset-icon");
