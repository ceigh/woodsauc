...
try{var socket=io("https://socket.donationalerts.ru:443",{reconnection:!1}),token=getCookie("token");token&&socket.emit("add-user",{token:token,type:"minor"});socket.on("donation",function(a){if(started&&(a=JSON.parse(a),1===a.alert_type||"1"===a.alert_type)){var b=a.message;b=b.replace(/\s+/g," ");for(var c=+a.amount,d=document.getElementsByClassName("name"),e=document.getElementsByClassName("cost"),f=document.getElementById("notifications-area"),k=!1,g={},n=0;n<Math.min(d.length,e.length);g={$jscomp$loop$prop$notification$0$15:g.$jscomp$loop$prop$notification$0$15},
n++){var l=d[n].value;if(l&&b.toLowerCase().includes(l.toLowerCase())){g.$jscomp$loop$prop$notification$0$15=document.createElement("div");g.$jscomp$loop$prop$notification$0$15.className="notification";g.$jscomp$loop$prop$notification$0$15.innerHTML='<p></p>\n                        <button class="notification-btn" type="button" title="\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c">\n                            <img src="static/icons/round-done-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f">\n                        </button>\n                        <button class="notification-btn" type="button" title="\u041e\u0442\u043a\u043b\u043e\u043d\u0438\u0442\u044c">\n                            <img src="static/icons/round-clear-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043e\u0447\u0438\u0441\u0442\u043a\u0438">\n                        </button>';
g.$jscomp$loop$prop$notification$0$15.children[0].innerText="\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u20bd"+c+' \u043a "'+l.toTitle().replace(/\s+$/,"")+'"?';g.$jscomp$loop$prop$notification$0$15.children[0].setAttribute("title","\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u20bd"+c+' \u043a "'+l.toTitle().replace(/\s+$/,"")+'"?');g.$jscomp$loop$prop$notification$0$15.children[1].onclick=function(a){return function(f){ripplet(f);e=document.getElementsByClassName("cost");d=document.getElementsByClassName("name");
for(f=0;f<Math.min(d.length,e.length);f++){var g=d[f].value,p=+e[f].value;g&&b.toLowerCase().includes(g.toLowerCase())&&(e[f].value=c+p,checkOnBuy(e[f]),sortCandidates(),changeTitle(e[f]),a.$jscomp$loop$prop$notification$0$15.classList.add("hidden"),setTimeout(function(){a.$jscomp$loop$prop$notification$0$15.remove()},300))}}}(g);g.$jscomp$loop$prop$notification$0$15.children[2].onclick=function(a){return function(b){ripplet(b);a.$jscomp$loop$prop$notification$0$15.classList.add("hidden");setTimeout(function(){a.$jscomp$loop$prop$notification$0$15.remove()},
300)}}(g);f.insertBefore(g.$jscomp$loop$prop$notification$0$15,f.firstElementChild);notificationSound();k=!0;break}}if(!k){var h=document.createElement("div");h.className="notification";h.innerHTML='<p></p>\n                    <button class="notification-btn" type="button" title="\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c">\n                        <img src="static/icons/round-done-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f">\n                    </button>\n                    <button class="notification-btn" type="button" title="\u041e\u0442\u043a\u043b\u043e\u043d\u0438\u0442\u044c">\n                        <img src="static/icons/round-clear-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043e\u0447\u0438\u0441\u0442\u043a\u0438">\n                    </button>';
...
candidatesArea.insertBefore(b,candidatesArea.lastElementChild);ripplet(a);setTimeout(function(){b.classList.add("visible")},10);b.children[0].children[0].focus();sortCandidates()};function setCookie(a,b,c){c=c||{};var d=c.expires;if("number"==typeof d&&d){var e=new Date;e.setTime(e.getTime()+1E3*d);d=c.expires=e}d&&d.toUTCString&&(c.expires=d.toUTCString());b=encodeURIComponent(b);a=a+"="+b;for(var f in c)a+="; "+f,b=c[f],!0!==b&&(a+="="+b);document.cookie=a}
function changeBG(a){var b=document.querySelector("body"),c=new Image;a&&""!==a?(c.onload=function(){b.style.backgroundImage="url("+c.src+")"},c.src=a):b.style.backgroundImage=firefox?"url('static/38263.jpg')":"url('static/38263.webp')"}function sheet(a){var b=document.createElement("style");b.appendChild(document.createTextNode(a));document.head.appendChild(b);return b}function textSelect(a){a.focus();a.select()}
...
function notification(a){var b=document.getElementById("notifications-area"),c=document.createElement("div"),d=document.createElement("p");d.innerText=a;d.setAttribute("title",a);c.appendChild(d);c.className="notification";b.insertBefore(c,b.firstElementChild);notificationSound();setTimeout(function(){c.classList.add("hidden");setTimeout(function(){c.remove()},300)},1200)}
