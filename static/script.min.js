...
function deleteNotification(a){a.parentElement.remove()}var started=!1;
try{var socket=io("https://socket.donationalerts.ru:443",{reconnection:!1}),token=getCookie("token");token&&socket.emit("add-user",{token:token,type:"minor"});socket.on("donation",function(a){if(started){var b=JSON.parse(a);if(1===b.alert_type){a=b.message;var c=b.amount;b=document.getElementsByClassName("name");for(var d=document.getElementsByClassName("cost"),e=document.getElementById("notifications-area"),f=!1,g={$jscomp$loop$prop$i$6:0};g.$jscomp$loop$prop$i$6<Math.min(b.length,d.length);g={$jscomp$loop$prop$i$6:g.$jscomp$loop$prop$i$6,
$jscomp$loop$prop$cost$7:g.$jscomp$loop$prop$cost$7},g.$jscomp$loop$prop$i$6++){var h=b[g.$jscomp$loop$prop$i$6].value;g.$jscomp$loop$prop$cost$7=+d[g.$jscomp$loop$prop$i$6].value;if(h&&a.toLowerCase().includes(h.toLowerCase())){f=document.createElement("div");f.className="notification";f.innerHTML='<div title="\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c '+c+" \u043a "+h+'?">\n                            \u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c '+c+" \u043a "+h+'?</div>\n                        <button class="notification-btn" type="button" title="\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c">\n                            <img src="static/icons/round-done-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f">\n                        </button>\n                        <button class="notification-btn" type="button" title="\u041e\u0442\u043c\u0435\u043d\u0438\u0442\u044c">\n                            <img src="static/icons/round-clear-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043e\u0447\u0438\u0441\u0442\u043a\u0438">\n                        </button>';
f.children[1].onclick=function(a){return function(){d[a.$jscomp$loop$prop$i$6].value=c+a.$jscomp$loop$prop$cost$7;this.parentElement.remove()}}(g);f.children[2].onclick=function(){this.parentElement.remove()};e.insertBefore(f,e.firstElementChild);f=!0;break}}if(!f)for(g=document.createElement("div"),g.className="notification",g.innerHTML='<div title="\u0421\u043e\u0437\u0434\u0430\u0442\u044c '+a+" \u0441 "+c+'?">\n                        \u0421\u043e\u0437\u0434\u0430\u0442\u044c '+a+" \u0441 "+
c+'?</div>\n                    <button class="notification-btn" type="button" title="\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c">\n                        <img src="static/icons/round-done-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f">\n                    </button>\n                    <button class="notification-btn" type="button" title="\u041e\u0442\u043c\u0435\u043d\u0438\u0442\u044c"\n                    onclick="deleteNotification(this)">\n                        <img src="static/icons/round-clear-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043e\u0447\u0438\u0441\u0442\u043a\u0438">\n                    </button>',
e.insertBefore(g,e.firstElementChild),e=document.createElement("div"),e.className="block",e.innerHTML='<label>\n                       <input class="name" type="text" onkeyup="changeSize(this);createLink(this)"\n                         title="\u0424\u0438\u043b\u044c\u043c, \u0438\u0433\u0440\u0430, etc" value="'+a+'" autocomplete="off" placeholder="\u041f\u043e\u0437\u0438\u0446\u0438\u044f">\n                       <input class="cost" type="number" min="0" \n                         onkeyup="changeTitle(this)" onchange="sortCandidates()" placeholder="\u20bd" title="\u0421\u0443\u043c\u043c\u0430" \n                         value="'+
...
candidatesArea.insertBefore(e,candidatesArea.lastElementChild),sortCandidates(),a=0;a<b.length;a++)createLink(b[a])}}})}catch(a){console.log("\u041d\u0435\u0442 \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u044f, \u0430\u0432\u0442\u043e\u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043d\u0435 \u0431\u0443\u0434\u0435\u0442 \u0440\u0430\u0431\u043e\u0442\u0430\u0442\u044c.")}var defaultSize=16.2,maxSize=defaultSize,styleForSize=document.createElement("style");
