...
try{var socket=io("https://socket.donationalerts.ru:443",{reconnection:!1}),token=getCookie("token");token&&socket.emit("add-user",{token:token,type:"minor"});socket.on("donation",function(a){if(started&&(a=JSON.parse(a),1==a.alert_type)){var b=a.message,c=+a.amount,d=document.getElementsByClassName("name"),e=document.getElementsByClassName("cost");a=document.getElementById("notifications-area");for(var g=!1,f={$jscomp$loop$prop$i$6:0};f.$jscomp$loop$prop$i$6<Math.min(d.length,e.length);f={$jscomp$loop$prop$i$6:f.$jscomp$loop$prop$i$6,
$jscomp$loop$prop$cost$7:f.$jscomp$loop$prop$cost$7,$jscomp$loop$prop$notification$9:f.$jscomp$loop$prop$notification$9},f.$jscomp$loop$prop$i$6++){var k=d[f.$jscomp$loop$prop$i$6].value;f.$jscomp$loop$prop$cost$7=+e[f.$jscomp$loop$prop$i$6].value;if(k&&b.toLowerCase().includes(k.toLowerCase())){f.$jscomp$loop$prop$notification$9=document.createElement("div");f.$jscomp$loop$prop$notification$9.className="notification";f.$jscomp$loop$prop$notification$9.innerHTML='<div title="\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c '+
...
f.$jscomp$loop$prop$notification$9.children[1].onclick=function(a){return function(){e[a.$jscomp$loop$prop$i$6].value=c+a.$jscomp$loop$prop$cost$7;sortCandidates();a.$jscomp$loop$prop$notification$9.classList.add("hidden");setTimeout(function(){a.$jscomp$loop$prop$notification$9.remove()},300)}}(f);f.$jscomp$loop$prop$notification$9.children[2].onclick=function(a){return function(){a.$jscomp$loop$prop$notification$9.classList.add("hidden");setTimeout(function(){a.$jscomp$loop$prop$notification$9.remove()},
300)}}(f);a.insertBefore(f.$jscomp$loop$prop$notification$9,a.firstElementChild);g=!0;break}}if(!g){var h=document.createElement("div");h.className="notification";h.innerHTML='<div title="\u0421\u043e\u0437\u0434\u0430\u0442\u044c '+b+" \u0441 "+c+'?">\n                        \u0421\u043e\u0437\u0434\u0430\u0442\u044c '+b+" \u0441 "+c+'?</div>\n                    <button class="notification-btn" type="button" title="\u041f\u043e\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u044c">\n                        <img src="static/icons/round-done-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043f\u043e\u0434\u0442\u0432\u0435\u0440\u0436\u0434\u0435\u043d\u0438\u044f">\n                    </button>\n                    <button class="notification-btn" type="button" title="\u041e\u0442\u043a\u043b\u043e\u043d\u0438\u0442\u044c">\n                        <img src="static/icons/round-clear-24px.svg" alt="\u0418\u043a\u043e\u043d\u043a\u0430 \u043e\u0447\u0438\u0441\u0442\u043a\u0438">\n                    </button>';
h.children[1].onclick=function(){var a=document.createElement("div");a.className="block";a.innerHTML='<label>\n                           <input class="name" type="text" onkeyup="changeSize(this);createLink(this)"\n                             title="\u0424\u0438\u043b\u044c\u043c, \u0438\u0433\u0440\u0430, etc" value="'+b+'" autocomplete="off" placeholder="\u041f\u043e\u0437\u0438\u0446\u0438\u044f">\n                           <input class="cost" type="number" min="0" \n                             onkeyup="changeTitle(this)" onchange="sortCandidates()" placeholder="\u20bd" title="\u0421\u0443\u043c\u043c\u0430" \n                             value="'+
...
candidatesArea.insertBefore(a,candidatesArea.lastElementChild);sortCandidates();for(a=0;a<d.length;a++)createLink(d[a]);h.classList.add("hidden");setTimeout(function(){h.remove()},300)};h.children[2].onclick=function(){h.classList.add("hidden");setTimeout(function(){h.remove()},300)};a.insertBefore(h,a.firstElementChild)}}})}catch(a){console.log("\u041d\u0435\u0442 \u043f\u043e\u0434\u043a\u043b\u044e\u0447\u0435\u043d\u0438\u044f, \u0430\u0432\u0442\u043e\u0434\u043e\u0431\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043d\u0435 \u0431\u0443\u0434\u0435\u0442 \u0440\u0430\u0431\u043e\u0442\u0430\u0442\u044c.")}
var defaultSize=16.2,maxSize=defaultSize,styleForSize=document.createElement("style");styleForSize.appendChild(document.createTextNode(".name{width:"+defaultSize+"vw}"));document.head.appendChild(styleForSize);
